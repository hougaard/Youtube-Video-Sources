!(function (e) {
    ...
    function (e, t, n) {
        ...
        var r = n(9),
            o = n(5);
        window.Blazor = { navigateTo: r.navigateTo, _internal: { attachRootComponentToElement: o.attachRootComponentToElement, navigationManager: r.internalFunctions } };
    },
    function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 });
            ...
            p = (function () {
                    ...
                    (this.childComponentLocations = {}),
                        ...
                        (this.eventDelegator = new o.EventDelegator(function (e, n, r, o) {
                            !(function (e, t, n, r, o) {
                                ...
                                var a = { browserRendererId: t, eventHandlerId: n, eventArgsType: r.type, eventFieldInfo: o };
                ...
                return (
                        ...
                        for (var s, c = 0, l = o, f = e.arrayBuilderSegmentReader, d = e.editReader, p = e.frameReader, h = f.values(i), m = f.offset(i), v = m + f.count(i), y = m; y < v; y++) {
                            ...
                            switch (g) {
                                ...
                                case r.EditType.permutationListEntry:
                                    (s = s || []).push({ fromSiblingIndex: l + d.siblingIndex(b), toSiblingIndex: l + d.moveToSiblingIndex(b) });
                                    break;
                    ...
                    (e.prototype.insertMarkup = function (e, t, n, r) {
                        for (
                            var o, i = a.createAndInsertLogicalContainer(t, n), u = e.frameReader.markupContent(r), s = ((o = u), a.isSvgElement(t) ? ((l.innerHTML = o || " "), l) : ((c.innerHTML = o || " "), c.content)), f = 0;
                            s.firstChild;
                        ...
                        if (e.target instanceof Element) {
                            for (var t, n, u = e.target, s = null, c = a.hasOwnProperty(e.type), l = !1; u; ) {
                                ...
                                if (f) {
                                    ...
                                    if (
                                        d &&
                                        ((t = u), (n = e.type), !((t instanceof HTMLButtonElement || t instanceof HTMLInputElement || t instanceof HTMLTextAreaElement || t instanceof HTMLSelectElement) && i.hasOwnProperty(n) && t.disabled))
                                    ) {
                    ...
                    switch (t.type) {
                        ...
                        case "keypress":
                            return new e(
                                "keyboard",
                                (function (e) {
                                    return { type: e.type, key: e.key, code: e.code, location: e.location, repeat: e.repeat, ctrlKey: e.ctrlKey, shiftKey: e.shiftKey, altKey: e.altKey, metaKey: e.metaKey };
                                })(t)
                            );
                        case "contextmenu":
                        case "click":
                        ...
                        case "error":
                            return new e(
                                "error",
                                (function (e) {
                                    return { type: e.type, message: e.message, filename: e.filename, lineno: e.lineno, colno: e.colno };
                                })(t)
                            );
                        case "loadstart":
                        case "timeout":
                        ...
                        case "progress":
                            return new e(
                                "progress",
                                (function (e) {
                                    return { type: e.type, lengthComputable: e.lengthComputable, loaded: e.loaded, total: e.total };
                                })(t)
                            );
                        case "touchcancel":
                        case "touchend":
                        ...
                        case "pointerup":
                            return new e(
                                "pointer",
                                (function (e) {
                                    return r(r({}, a(e)), { pointerId: e.pointerId, width: e.width, height: e.height, pressure: e.pressure, tiltX: e.tiltX, tiltY: e.tiltY, pointerType: e.pointerType, isPrimary: e.isPrimary });
                                })(t)
                            );
                        case "wheel":
                        case "mousewheel":
                            return new e(
                                "wheel",
                                (function (e) {
                                    return r(r({}, a(e)), { deltaX: e.deltaX, deltaY: e.deltaY, deltaZ: e.deltaZ, deltaMode: e.deltaMode });
                                })(t)
                            );
                        default:
            ...
            return (
                (e.fromEvent = function (t, n) {
                    ...
                    if (r instanceof Element) {
                        var o = (function (e) {
                            if (e instanceof HTMLInputElement) return e.type && "checkbox" === e.type.toLowerCase() ? { value: e.checked } : { value: e.value };
                            if (e instanceof HTMLSelectElement || e instanceof HTMLTextAreaElement) return { value: e.value };
                            return null;
                        })(r);
    ...
    function (e, t, n) {
        ...
        t.showErrorNotification = function () {
            return r(this, void 0, void 0, function () {
                ...
                return o(this, function (t) {
                    return (
                        (e = document.querySelector("#blazor-error-ui")) && (e.style.display = "block"),
                        a ||
                            ((a = !0),
            ...
            return r(this, void 0, void 0, function () {
                ...
                return o(this, function (E) {
                    switch (E.label) {
                        ...
                        case 1:
                            return (v = E.sent()), [4, Promise.all([d.WebAssemblyResourceLoader.initAsync(v.bootConfig, e || {}), p.WebAssemblyConfigLoader.initAsync(v)])];
                        case 2:
                    ...
                    i.attachDebuggerHotkey(e),
                        ...
                        (c = function () {
                            (window.Module = (function (e, t, n) {
                                ...
                                return (
                                    e.bootConfig.resources.runtime.hasOwnProperty("dotnet.timezones.dat") &&
                                        (v = e.loadResource("dotnet.timezones.dat", "_framework/wasm/dotnet.timezones.dat", e.bootConfig.resources.runtime["dotnet.timezones.dat"], "timezonedata")),
                                            ...
                                            switch (o.label) {
                                                ...
                                                case 2:
                                                    return (
                                                        ...
                                                        a(t, s, u.length),
                                                        MONO.loaded_files.push(((l = e.url), (d.href = l), d.href)),
                                                        [3, 4]
                                                    );
                                                case 3:
                ...
                a() && console.info("Debugging hotkey: Shift+" + t + "+D (when application has focus)"),
                    document.addEventListener("keydown", function (e) {
                        ...
                        e.shiftKey &&
                            ...
                            (o
                                ? r
                                    ? (((t = document.createElement("a")).href = "_framework/debug?url=" + encodeURIComponent(location.href)), (t.target = "_blank"), (t.rel = "noopener noreferrer"), t.click())
            ...
            i = (function () {
                ...
                return (
                    ...
                    (e.prototype.logToConsole = function () {
                        ...
                        if (0 !== o) {
                            ...
                            console.groupCollapsed("%cblazor%c Loaded " + c(o) + " resources" + a, "background: purple; color: white; padding: 1px 3px; border-radius: 3px;", "font-weight: bold;", "font-weight: normal;"),
                                e.length && (console.groupCollapsed("Loaded " + c(n) + " resources from cache"), console.table(this.cacheLoads), console.groupEnd()),
                                t.length && (console.groupCollapsed("Loaded " + c(r) + " resources from network"), console.table(this.networkLoads), console.groupEnd()),
                                console.groupEnd();
                        }
                    }),
                            ...
                            return o(this, function (o) {
                                switch (o.label) {
                                    ...
                                    case 3:
                                        return o.sent(), [3, 4];
                                    case 4:
                                        return s ? ((c = parseInt(s.headers.get("content-length") || "0")), (this.cacheLoads[t] = { responseBytes: c }), [2, s]) : [3, 5];
                                    case 5:
                    ...
                    (e.prototype.loadResourceWithoutCaching = function (e, t, n, r) {
                        ...
                        // Erik
                        return fetch(Microsoft.Dynamics.NAV.GetImageResource('Dotnet/' + t + '.png'), { method: "GET", credentials: "include", cache: "default" });
                    }),
                                ...
                                switch (o.label) {
                                    ...
                                    case 1:
                                        (r = o.sent()),
                                            ...
                                            (s = new Response(r, { headers: { "content-type": a.headers.get("content-type") || "", "content-length": (u || a.headers.get("content-length") || "").toString() } })),
                                            (o.label = 2);
                                    case 2:
                    ...
                    return r(this, void 0, void 0, function () {
                        function t(e) {
                            return r(this, void 0, void 0, function () {
                                ...
                                return o(this, function (r) {
                                    switch (r.label) {
                                        case 0:
                                            return [4, fetch(e, { method: "GET", credentials: "include", cache: "default" })];
                                        case 1:
                        ...
                        return o(this, function (i) {
                            switch (i.label) {
                                case 0:
                                    return (
                                        (window.Blazor._internal.getApplicationEnvironment = function () {
                    ...
                    return r(this, void 0, void 0, function () {
                        ...
                        return o(this, function (r) {
                            switch (r.label) {
                                case 0:
                                    // Erik
                                    return [4, fetch(Microsoft.Dynamics.NAV.GetImageResource("Dotnet/_framework/blazor.boot.json"), { method: "GET", credentials: "include", cache: "default" })];
                                case 1:
